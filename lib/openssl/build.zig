...
pub fn buildCrypto(b: *Builder, target: std.zig.CrossTarget, mode: std.builtin.Mode) !*LibExeObjStep {
    ...
    if (target.getOsTag() == .windows) {
        lib.addIncludeDir("./lib/openssl/windows/include");
    } else {
...
pub fn buildSsl(b: *Builder, target: std.zig.CrossTarget, mode: std.builtin.Mode) !*LibExeObjStep {
