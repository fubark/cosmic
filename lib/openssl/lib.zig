...
pub fn createCrypto(
    ...
    if (target.getOsTag() == .windows) {
        lib.addIncludeDir(fromRoot(b, "windows/include"));
    } else {
        lib.addIncludeDir(fromRoot(b, "unix/include"));
    }

    lib.addIncludeDir(fromRoot(b, "vendor/providers/implementations/include"));
    lib.addIncludeDir(fromRoot(b, "vendor/providers/common/include"));
