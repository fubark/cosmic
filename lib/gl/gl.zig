...
var winUseProgram: *const fn (program: c.GLuint) void = undefined;
var winCreateShader: *const fn (@"type": c.GLenum) c.GLuint = undefined;
var winGetShaderInfoLog: *const fn (shader: c.GLuint, bufSize: c.GLsizei, length: [*c]c.GLsizei, infoLog: [*c]c.GLchar) void = undefined;
var winDeleteShader: *const fn (shader: c.GLuint) void = undefined;
var winCreateProgram: *const fn () c.GLuint = undefined;
var winAttachShader: *const fn (program: c.GLuint, shader: c.GLuint) void = undefined;
var winLinkProgram: *const fn (program: c.GLuint) void = undefined;
var winGetProgramiv: *const fn (program: c.GLuint, pname: c.GLenum, params: [*c]c.GLint) void = undefined;
var winGetProgramInfoLog: *const fn (program: c.GLuint, bufSize: c.GLsizei, length: [*c]c.GLsizei, infoLog: [*c]c.GLchar) void = undefined;
var winDeleteProgram: *const fn (program: c.GLuint) void = undefined;
var winGenVertexArrays: *const fn (n: c.GLsizei, arrays: [*c]c.GLuint) void = undefined;
var winShaderSource: *const fn (shader: c.GLuint, count: c.GLsizei, string: [*c]const [*c]const c.GLchar, length: [*c]const c.GLint) void = undefined;
var winCompileShader: *const fn (shader: c.GLuint) void = undefined;
var winGetShaderiv: *const fn (shader: c.GLuint, pname: c.GLenum, params: [*c]c.GLint) void = undefined;
var winBindBuffer: *const fn (target: c.GLenum, buffer: c.GLuint) void = undefined;
var winBufferData: *const fn (target: c.GLenum, size: c.GLsizeiptr, data: ?*const anyopaque, usage: c.GLenum) void = undefined;
var winUniformMatrix3fv: *const fn (location: c.GLint, count: c.GLsizei, transpose: c.GLboolean, value: [*c]const c.GLfloat) void = undefined;
var winUniformMatrix4fv: *const fn (location: c.GLint, count: c.GLsizei, transpose: c.GLboolean, value: [*c]const c.GLfloat) void = undefined;
var winUniform1fv: *const fn (location: c.GLint, count: c.GLsizei, value: [*c]const c.GLfloat) void = undefined;
var winUniform2fv: *const fn (location: c.GLint, count: c.GLsizei, value: [*c]const c.GLfloat) void = undefined;
var winUniform3fv: *const fn (location: c.GLint, count: c.GLsizei, value: [*c]const c.GLfloat) void = undefined;
var winUniform4fv: *const fn (location: c.GLint, count: c.GLsizei, value: [*c]const c.GLfloat) void = undefined;
var winGetUniformLocation: *const fn (program: c.GLuint, name: [*c]const c.GLchar) c.GLint = undefined;
var winUniform1i: *const fn (location: c.GLint, v0: c.GLint) void = undefined;
var winGenBuffers: *const fn (n: c.GLsizei, buffers: [*c]c.GLuint) void = undefined;
var winDeleteBuffers: *const fn (n: c.GLsizei, buffers: [*c]const c.GLuint) void = undefined;
var winBlendEquation: *const fn (mode: c.GLenum) void = undefined;
var winBlitFramebuffer: *const fn (srcX0: c.GLint, srcY0: c.GLint, srcX1: c.GLint, srcY1: c.GLint, dstX0: c.GLint, dstY0: c.GLint, dstX1: c.GLint, dstY1: c.GLint, mask: c.GLbitfield, filter: c.GLenum) void = undefined;
var winDeleteVertexArrays: *const fn (n: c.GLsizei, arrays: [*c]const c.GLuint) void = undefined;
var winVertexAttribPointer: *const fn (index: c.GLuint, size: c.GLint, @"type": c.GLenum, normalized: c.GLboolean, stride: c.GLsizei, pointer: ?*const anyopaque) void = undefined;
var winBindVertexArray: *const fn (array: c.GLuint) void = undefined;
var winDetachShader: *const fn (program: c.GLuint, shader: c.GLuint) void = undefined;
var winFramebufferTexture2D: *const fn (target: c.GLenum, attachment: c.GLenum, textarget: c.GLenum, texture: c.GLuint, level: c.GLint) void = undefined;
var winTexImage2DMultisample: *const fn (target: c.GLenum, samples: c.GLsizei, internalformat: c.GLenum, width: c.GLsizei, height: c.GLsizei, fixedsamplelocations: c.GLboolean) void = undefined;
var winGenFramebuffers: *const fn (n: c.GLsizei, framebuffers: [*c]c.GLuint) void = undefined;
var winEnableVertexAttribArray: *const fn (index: c.GLuint) void = undefined;
var winActiveTexture: *const fn (texture: c.GLenum) void = undefined;
var winBindFramebuffer: *const fn (target: c.GLenum, framebuffer: c.GLuint) void = undefined;
var winCheckFramebufferStatus: *const fn (target: c.GLenum) c.GLenum = undefined;
