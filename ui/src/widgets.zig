...
pub const MouseHoverAreaUI = mouse_area.MouseHoverArea;
pub const MouseHoverArea = genBuildWithChild(MouseHoverAreaUI);
pub const MouseDragAreaUI = mouse_area.MouseDragArea;
pub const MouseDragArea = genBuildWithChild(MouseDragAreaUI);
