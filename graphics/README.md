...
### Dependencies
Get the Zig compiler (0.9.0) [here](https://ziglang.org/download/). On Linux you'll need SDL2 installed. You need to pull the deps repo which has header files, prebuilt libs, and assets for the demo:
```sh
